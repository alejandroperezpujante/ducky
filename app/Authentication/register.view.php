...
<x-base :title="'Create Account'" :active="'identify'">
    <main class="w-full">
        <div class="isolate">

            <section class="flex flex-col items-center px-6 pt-10 sm:pt-16 pb-10 text-center">
                <div class="max-w-2xl w-full">
                    <h1 class="text-4xl sm:text-6xl text-balance">Create Account</h1>
                </div>
            </section>
            ...
            <section class="px-6 pb-12">
                <div class="max-w-md mx-auto bg-white rounded-bubble shadow-soft p-8 flex flex-col gap-6">
                    ...
                    <p class="text-center text-sm text-ink-500">
                        ...
                        <a href="/login" class="text-coral-500 font-semibold hover:underline">Sign in</a>
                    </p>

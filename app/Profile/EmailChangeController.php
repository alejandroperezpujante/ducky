...
use App\Authentication\SessionInvalidator;
...
final readonly class EmailChangeController
{
    ...
    /**
     * Step 2: User clicks the signed link → password-protected form to enter new email.
     */
    #[Get('/profile/email/change', middleware: [MustBeAuthenticated::class])]
